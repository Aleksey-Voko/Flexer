...
from bs_lists.nouns import (get_nouns, get_inanimate_nouns, get_animate_nouns,
                            ...
                            get_nouns_identifiers,
                            get_nouns_ch_both_parts_identifiers)
...
from bs_lists.verbs import get_verbs, get_imperfective_verbs, get_perfect_verbs
...
EXPLICIT_TASKS = {
    ...
    'Существительные. Идентификаторы.txt': get_nouns_identifiers,
    'Сущ-ные с дефисом. Изм. обе части. Идентификаторы.txt': get_nouns_ch_both_parts_identifiers,
