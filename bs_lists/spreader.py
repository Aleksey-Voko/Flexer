...
from bs_lists.numerals import (get_numerals, get_numerals_implicit_pattern,
                               ...
                               get_numerals_hyphenated_identifiers)
from bs_lists.pronouns import (get_pronouns, get_pronouns_no_plural,
                               ...
                               get_pronouns_hyphenated_identifiers)
...
EXPLICIT_TASKS = {
    ...
    'Мест-ния с дефисом. Изм. обе части. Идентификаторы.txt': get_pronouns_hyphenated_identifiers,
    ...
    'Числ-ные с дефисом. Изм. обе части. Идентификаторы.txt': get_numerals_hyphenated_identifiers,
